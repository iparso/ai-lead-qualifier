    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex justify-end pt-2">
        <button
          type="submit"
          disabled={disabled}
          className="bg-accent text-primary font-semibold text-sm px-8 py-3 rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed"
        >
